// netlify/functions/pmstatus.js — Netlify Functions版
// ------------------------------------------------------------
...
// 個網睇落乜事都冇但你就係落唔到單。
//
// ⚠️同 functions/api/pmstatus.js 係孖生:改一份要兩份一齊改。
...
const CACHE_HEADERS = { "Content-Type": "application/json", "Cache-Control": "no-store" };
...
exports.handler = async function () {
  ...
  return { statusCode: 200, headers: CACHE_HEADERS, body: JSON.stringify({
