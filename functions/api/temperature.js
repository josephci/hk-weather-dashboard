...
// ⚠️2026-09-13訂正:呢條**唔係**最快。下面09-08寫嗰段係錯嘅,留住做紀錄。
//
// 09-13 12:11同一刻實測:
//   網站JSON (BulletinTime 12:02)  溫度=30  濕度=69
//   CSV / AWS-GIS / 天文台首頁      溫度=29.8 濕度=70  (12:00觀測)
// **濕度69 vs 70兩個都係整數,唔存在捨入差異** → 網站JSON嗰組數係
// 另一個時刻(多數11:50)嘅觀測,唔係12:00。公報係新,入面啲數係舊。
//
// 09-08我量嘅係「份公報幾時出現」,唔係「入面個讀數幾舊」。兩樣完全唔同。
// 所以dashboard個⚡已經(09-10)換返rhrread做主源。呢條留住做交叉對照,
// 唔好再當佢快。
//
// ↓↓↓ 以下係09-08嗰個錯結論,唔好照信 ↓↓↓
